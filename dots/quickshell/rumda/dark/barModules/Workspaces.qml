...
Rectangle {
  ...
  readonly property int moduleRadius: 3
  readonly property int moduleBorderWidth: 1
  readonly property int workspaceSpacing: 5
  readonly property int workspaceInnerSpacing: -3
  readonly property int workspaceWidth: 12
  readonly property int workspaceActiveHeight: 40
  readonly property int workspaceInactiveHeight: 25
